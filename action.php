...
if(isset($_POST["category"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
					<li><a class='clc' href='#' cid='$cid'>$cat_name</a></li>
			";
		}
	}
}
...
if(isset($_POST["getProduct"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
				<div class='product_item float-left'>
				<div class='product_border'></div>
				<div class='product_image d-flex flex-column align-items-center justify-content-center'><img src='product_images/$pro_image' style='width:160px; height:250px;' ></div>
				<div class='product_content'>
													<div class='product_price'>₹.$pro_price.00</div>
													<div class='product_name'><div><a href='product.html' tabindex='0'>$pro_title</a></div></div>
													<div class='add_to_cart'>
														<button pid='$pro_id' class='add_to_cart_btn btn btn-info' tabindex='0'>Add to Cart</button>
													</div>
												</div>
				</div>
	...
	while($row=mysqli_fetch_array($run_query)){
			...
			echo "
				...
				<div class='product_content'>
													...
													<div class='product_name'><div><a href='product.html' tabindex='0'>$pro_title</a></div></div>
													<div class='add_to_cart'>
														<button pid='$pro_id' class='btn add_to_cart_btn btn-info' tabindex='0'>Add to Cart</button>
													</div>
												</div>
				</div>
			";
